...
<script type="text/javascript">
	...
	$.ajax({
				...
				url : "purchaseItemAction_add.action",
	...
	<div class="contact">
		<form name="form1" method="post" action="userAction_register.action">
			...
			<ul><input type="hidden" name="purchaseOrderId"
				...
				<input type="hidden" name="assetSortId" id="assetSortId"/>	  	
				</li>
				
				<li><label>资产名称：</label> <input type="text" name="assettName"
					id="assettName" placeholder="请输入资产名称" required />
					
				</li>
				
				<li><label>型号：</label> <input type="text" name="assetType"
					id="assetType" placeholder="请输入型号" required />
				...
				<li><label>数量：</label> <input type="text" name="num"
					id="num" placeholder="请输入数量" required />
					
				</li>
				
				<li><label>单位：</label> <input type="text" name="unit"
					id="unit" placeholder="请输入单位" required />
					
				</li>
				
				<li><label>单价：</label> <input type="text" name="price"
					id="price" placeholder="请输入单价" required />
					
				</li>
				
				<li><label>制造商：</label> <input type="text" name="manufacturer"
					id="manufacturer" placeholder="请输入制造商" required />
					
				</li>
				
				<li><label>供应商：</label> <input type="text" name="supplier"
					id="supplier" placeholder="请输入供应商" required />
					
				</li>
				
				
				<li><label>备注：</label> <input type="text" name="remarks"
