...
jBoxConfig.defaults = {
    id: "id-jbox-dialog", /* 在页面中的唯一id，如果为null则自动生成随机id,一个id只会显示一个jBox */
...
jBoxConfig.tipDefaults = {
    ...
    top: '20%', /* 提示离顶部的距离,可以是百分比或像素(如 '100px') */
    width: 'auto', /* 提示的高度，值为'auto'或表示像素的整数 */
    height: 'auto', /* 提示的高度，值为'auto'或表示像素的整数 */
    opacity: 0, /* 窗口隔离层的透明度,如果设置为0,则不显示隔离层 */
    timeout: 1500, /* 提示显示多少毫秒后自动关闭,必须是大于0的整数 */
...
jBoxConfig.messagerDefaults = {
    ...
    width: 250, /* 信息的高度，值为'auto'或表示像素的整数 */
